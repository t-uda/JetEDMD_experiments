...
class Model(ABC):
    ...
    @abstractmethod
    def predict_derivative(self, t: float, x: np.ndarray, u: Optional[np.ndarray]=None) -> np.ndarray:
        pass

    def rollout(self, t: np.ndarray, x0: np.ndarray, u: Optional[np.ndarray]=None) -> np.ndarray:
