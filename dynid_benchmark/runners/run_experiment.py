    ...
    for r in r_list:
        for snr_db in snr_list:
            for seed in seeds:
                ...
                outdir = os.path.join(
                    args.outdir, os.path.splitext(os.path.basename(args.config))[0], tag
                )
                ...
                t_train = splits["train"]["t"]
                y_train = splits["train"]["y"]
                u_train = splits["train"].get("u")
                t_test = splits["test"]["t"]
                ...
                for mkey in args.models.split(","):
                    ...
                    plot_rollout(
                        ...
                        y_test,
                        y_pred,
                        os.path.join(outdir, f"rollout_{mkey}.png"),
                    )
